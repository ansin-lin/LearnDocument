...
from employees.api_views import AttachmentDownloadView, api_health
...
urlpatterns = [
    ...
    path('api/attachments/<int:attachment_id>/download/', AttachmentDownloadView.as_view(), name='api-attachment-download'),

...
完成课程后，你可以独立制作“有給休暇申請システム”的 HTML 结构，其中包括：
...
你还可以检查标签嵌套、文件路径、表格结构、表单属性和语义结构是否正确。HTML 阶段只负责页面结构，不添加 CSS 和 JavaScript。
...
15. [HTML 递进练习自测核对](15_newcomer_practice_answers.md)
